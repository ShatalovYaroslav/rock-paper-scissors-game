...
import org.myproject.game.service.DecisionEngine;
...
public class GameRest {
    ...
    public ResponseEntity<List<PlayerResult>> playWithPC(@ApiParam(value = "The user should provide requested model in json format to play: \n " +
        ...
        PlayerMove PCMove = new PlayerMove("pc_id",  GameMove.PAPER);
        logger.info("Creating answer from PC for now" + PCMove);
